...
<tr>
	...
	<td class="field-options">
		...
		<input type="text" class="input-text options" name="field_options[
		<?php echo esc_attr( $index ); ?>]" placeholder="<?php esc_attr_e( 'Pipe (|) separate options.', 'wp-job-manager-applications' ); ?>" value="<?php echo esc_attr( isset( $field['options'] ) ? implode( ' | ', $field['options'] ) : '' ); ?>" />
