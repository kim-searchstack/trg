    ...
    <div class="wpjb-grid wpjb-grid-compact wpjb-grid-closed-top">
        ...
        <div class="wpjb-grid-row">
            <div class="wpjb-col-100">
                <span class="wpjb-widget-grid-link"><a class="recent-job-title" href="<?php echo wpjb_link_to("job", $job) ?>"><?php esc_html_e($job->job_title) ?></a></span><br/>
                <span class="wpjb-sub recent-block-location"><?php esc_html_e($job->locationToString()); ?> <span class="wpjb-glyphs wpjb-icon-location"></span></span>
                <div class="recent-salary-container"><?php esc_html_e($job->meta->salary->value()) ?></div>
                <a class="recent-job-title" href="<?php echo wpjb_link_to("job", $job) ?>"><button class="ta-1 recent-block-button">Read more</button></a>
            </div>
        </div>
        <?php endforeach; ?>
        <div class="">
